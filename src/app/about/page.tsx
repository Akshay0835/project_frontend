    ...
    <section className="min-h-screen pt-40 pb-20 px-6 flex flex-col items-center relative z-10 w-full">
      <div className="container mx-auto max-w-5xl">
        <motion.div
          ...
          className="text-center mb-24 bg-black/50 backdrop-blur-md p-10 rounded-3xl border border-white/10"
        >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-24">
          {[
            ...
            <motion.div
              ...
              className="flex flex-col items-center justify-center p-8 rounded-2xl bg-black/60 border border-white/10 backdrop-blur-md"
            >
              <span className="text-4xl font-bold text-white mb-2">{stat.value}</span>
              <span className="text-xs text-slate-400 uppercase tracking-widest text-center">{stat.label}</span>
            </motion.div>
          ))}
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <motion.div
            ...
            className="p-10 rounded-3xl bg-black/60 border border-white/10 backdrop-blur-xl relative overflow-hidden group hover:border-cyan-500/50 transition-colors duration-500"
          >
          ...
          <motion.div
            ...
            className="p-10 rounded-3xl bg-black/60 border border-white/10 backdrop-blur-xl relative overflow-hidden group hover:border-emerald-500/50 transition-colors duration-500"
          >
